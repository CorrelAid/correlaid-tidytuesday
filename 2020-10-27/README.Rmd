...
ttheme_set(theme_minimal(base_family = "Roboto Condensed"))

t <- tt_load("2020-10-27")
df_wind <- tt$`wind-turbine`
```

```{r eig.width = 9, fig.height = 6}
...
sf_cind <- 
  ...
  st_transform(crs = s"+proj=lcc +lon_0=-90 +lat_1=33 +lat_2=45"
